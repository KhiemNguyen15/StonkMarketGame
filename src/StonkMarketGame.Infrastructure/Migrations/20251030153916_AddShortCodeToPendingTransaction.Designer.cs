...
namespace StonkMarketGame.Infrastructure.Migrations
{
    ...
    [Migration("20251030153916_AddShortCodeToPendingTransaction")]
    partial class AddShortCodeToPendingTransaction
    {
        /// <summary>
        /// Configures the Entity Framework Core model that represents the target database schema for this migration.
        /// </summary>
        /// <param name="modelBuilder">The builder used to construct the model's entity types, properties, keys, indexes, and table mappings.</param>
